...
1.	Open an available ``OMERO_import_template_wMacros_vXX.xlsm`` spreadsheet and fill in the ``Project_Name`` and ``Dataset_Name`` fields as explained in Points 4 and 10.
